...
//  alert box telling the user what is happening.
alert(' We are going to do some math! ');

//  collecting a number from the user and converting to an integer
var firstnumber = prompt(' Please pick any number ');
firstnumber = parseInt(firstnumber);

//  collecting a 2nd number and converting it into a interger
var seconednumber = prompt(' Please pick another number ');
seconednumber = parseInt(seconednumber);

//  message
var message = '<h1> Fun Maths with the numbers ' + firstnumber + ' and ' + seconednumber; + '</h1>';

// addition
message += '<h3>' + '<br>' + firstnumber + ' + ' + seconednumber + ' = ' + (firstnumber + seconednumber);

//multiplication
message += '<br>' + firstnumber + ' * ' + seconednumber + ' = ' + (firstnumber * seconednumber);
